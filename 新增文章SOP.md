...
每次請我改文章或新增文章，我會照這個順序做，不用每次交代：

1. **寫入 Google Drive** — 存一份到「Ray的業務日嚐」資料夾，方便你日後編輯
2. **產出 HTML 給你看** — 附上文章頁的 .html 檔，你雙擊就能在瀏覽器預覽實際排版
3. **等你確認後才打包** — 確認沒問題，我再更新 blog.html／index.html／sitemap.xml、串上一篇下一篇，最後打包整站 zip
